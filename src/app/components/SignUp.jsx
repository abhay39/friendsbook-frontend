  ...
  return (
    <div className=' p-3  md:flex shadow-lg '>
      <div>
        ...
        <div>
          <label className='text-[13px]' htmlFor="">Full Name</label>
          <br />
          <input type="text" placeholder="Enter your fullname" className='p-2  border-b-2 outline-none w-[100%] border-slate-400'/>
        </div>
      ...
      <div className='md:ml-6 mt-3 md:mt-0'>
        <h1 className='font-bold text-xl'>Social Signup</h1>
        <p className='text-slate-400  text-sm'>Quickly signup with your social network</p>
